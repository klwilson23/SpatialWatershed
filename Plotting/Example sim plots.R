...
tiff("Figures/example landscape results.tiff",units="in",height=8,width=8,res=800,compression="lzw")
layout(matLayout)
...
spatialRecoveryPlotv2(textSize=1,dendriticSim$popDyn,dendriticSim$MetaPop,dendriticSim$k_p,Nlevels=10,dendriticSim$recovery,Nburnin,Nyears,nodeScalar=35,dendriticSim$network,networkType="dendritic",Npatches=Npatches)
dev.off()
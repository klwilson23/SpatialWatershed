...
```{r recruit curves, echo=FALSE,warning = F, message = F,fig.width=7, fig.height = 6,fig.cap="Metapopulation and local patch recruitment dynamics.",out.width = ".7\\textwidth", fig.align="right", wrapfigure = list("R", .7),out.extra = 'trim = {0 1.1cm 0 0}, clip'}
...
```{r networks, echo=FALSE,fig.width=5, fig.height=5,fig.pos="H",fig.cap="Four spatial network topologies."}

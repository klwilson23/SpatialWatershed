...
2. Patch occupancy - the mean number of patches with `>0.1` local carrying capacity after short-term (5 years), medium-term (10 years), and long-term (25 years) after disturbance. This value characterizes the expected risk of spatial contractions or local patch collapses, and reflects how interactions between spatial structure, disturbance, and dispersal shape source-sink dynamics to provide rescue effects and recover local patches.

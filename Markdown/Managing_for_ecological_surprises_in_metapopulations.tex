...
\setlength{\droptitle}{-2em}
  ...
  \href{mailto:kl_wilson@sfu.ca}{\nolinkurl{kl\_wilson@sfu.ca}}}\textup{, Alex Sawyer$^a$, Anna Potapova$^a$, Colin Bailey$^a$, Elissa Sweeney-Bergen$^a$, Emma Hogson$^a$, Kara Pitman$^a$, Karl Seitz$^a$, Lauren Law$^a$, Luke Warkentin$^a$, Sam Wilson$^a$, William Atlas$^a$, Daniella LoScerbo$^b$, Doug C. Braun$^c$, Matt Sloat$^d$, Tim Tinker$^e$, and Jonathan W. Moore$^{a,c}$}\\
~\\
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_files/figure-latex/Recovery-1} 
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_files/figure-latex/unrecovered with variable patches-1} 

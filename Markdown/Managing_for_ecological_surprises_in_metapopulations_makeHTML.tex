...
\item
  ...
  \texttt{\textgreater{}0.1} local carrying capacity after short-term (5
  years), medium-term (10 years), and long-term (25 years) after
  disturbance. This value characterizes the expected risk of spatial
  ...
  source-sink dynamics to provide rescue effects and recover local
  patches.
\item
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_makeHTML_files/figure-latex/patch occupancy-1} 
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_makeHTML_files/figure-latex/patch occupancy with variable patches-1} 
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_makeHTML_files/figure-latex/patch occupancy with variable patches and stochasticity-1} 
...
{\centering \includegraphics{Managing_for_ecological_surprises_in_metapopulations_makeHTML_files/figure-latex/patch occupancy with variable patches and space-time stochasticity-1} 

...
<br>
```{r networks, echo=FALSE,fig.hold=TRUE,fig.width=4, fig.height = 4,fig.cap="Four spatial network topologies.",fig.align="center"}
source("Functions/some functions.R")
source("Functions/make networks.R")
patchDist <- 1
Npatches <- 16
...
\newpage
### General patterns in the risk of spatial contraction

...
author: |
  | Kyle L. Wilson$^a$^[Corresponding author - email: kl\_wilson@sfu.ca], Alex Sawyer$^a$, Anna Potapova$^a$, Colin J. Bailey$^a$,Daniella LoScerbo$^b$,
  | Elissa Sweeney-Bergen$^{a,c}$, Emma E. Hodgson$^{a,d}$, Kara J. Pitman$^a$, Karl Seitz$^a$,
  | Lauren Law$^{a,d}$, Luke Warkentin$^{a,d}$, Samantha M. Wilson$^a$, William I. Atlas$^{a,e}$, 
...
```{r disturbance regime, echo=FALSE,fig.height=6,fig.width=6,fig.cap="Spatial and temporal recovery patterns along disturbance regimes across all scenarios.",fig.align="center"}

...
author: |
  | Kyle L. Wilson$^\textup{a}$^[Corresponding author - email: kl\_wilson@sfu.ca], Alexandra C. Sawyer$^\textup{a}$, Anna Potapova$^\textup{a}$, Colin J. Bailey$^\textup{a}$,Daniella LoScerbo$^\textup{b}$,
  | Elissa K. Sweeney-Bergen$^\textup{a,c}$, Emma E. Hodgson$^\textup{a,d}$, Kara J. Pitman$^\textup{a}$, Karl M. Seitz$^\textup{a}$,
  | Lauren Law$^\textup{a,e}$, Luke Warkentin$^\textup{a,f}$, Samantha M. Wilson$^\textup{a}$, William I. Atlas$^\textup{a,g}$, 
  | Douglas C. Braun$^\textup{d}$, Matthew R. Sloat$^\textup{g}$, M. Tim Tinker$^\textup{h}$, 
  ...
  | $^\textup{c}$Ministry of Forests, Lands, Natural Resource Operations, and Rural Development, Smithers, BC
  | $^\textup{d}$Fisheries & Oceans Canada, Cultus Lake Laboratory, Cultus Lake, BC
  | $^\textup{d}$Fisheries & Oceans Canada, Salmonid Enhancement Program, Nanaimo, BC
  | $^\textup{d}$Fisheries & Oceans Canada, Stock Assessment & Research, Delta, BC
  | $^\textup{e}$Wild Salmon Center, Portland, OR
...
p1 <- ggplot(surprises,aes(y = surprise_logic,axis1 = network_lab, axis2 = dispersal_range,axis3=disturb_lab,axis4=cluster_surprises)) +
      ...
      scale_x_discrete(limits = c("Network structure", "Dispersal","Disturbance","Outcome"),expand=c(0.1,0.1)) +

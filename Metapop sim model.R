...
sinkVar <- colSums(sink,na.rm=TRUE)/Nyears
sourceVar <- colSums(source,na.rm=TRUE)/Nyears
pseudoSinkVar <- colSums(pseudoSink,na.rm=TRUE)/Nyears
sinkCV <- sd(sinkVar)/mean(sinkVar)
